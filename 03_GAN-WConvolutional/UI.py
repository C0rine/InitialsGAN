...
lrateval = 0.0005
clampval = 0.01
savepathval = 'Z:/GAN-Training-Results/WConvolutional_64x64_32bs/'
...
def getformattedparms():
	modelsettings = 'ConvolutionalGAN, ' + loss.value + ' loss, ' + optim.value + ' optimizer, ' + norm.value + ', batchsize of ' + batch.value + ', learning rate of ' + str(lrate.value) + ', for ' + str(epochs.value) + ' epochs.'
